...
public class Day03 implements Puzzle {
    private static String PATH = "C:\\Users\\arina\\IdeaProjects\\untitled2\\src\\main\\resources\\22_3.txt";
    ...
    public static String sameItems(String string){
        ...
        String part2 = string.substring((string.length()/2), string.length());
